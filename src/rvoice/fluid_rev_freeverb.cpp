...
static void
fluid_freeverb_revmodel_processreplace(fluid_revmodel_freeverb_t *rev,
                                       const fluid_real_t *in,
...
static void
fluid_freeverb_revmodel_processmix(fluid_revmodel_freeverb_t *rev,
                                   const fluid_real_t *in,
                                   fluid_real_t *left_out,
                                   fluid_real_t *right_out)
{
...
void fluid_revmodel_freeverb::processmix(const fluid_real_t *in, fluid_real_t *left_out,
                                         fluid_real_t *right_out)
{
    fluid_freeverb_revmodel_processmix(this, in, left_out, right_out);
}

void fluid_revmodel_freeverb::processreplace(const fluid_real_t *in, fluid_real_t *left_out,
                                             fluid_real_t *right_out)
{
    fluid_freeverb_revmodel_processreplace(this, in, left_out, right_out);
}
